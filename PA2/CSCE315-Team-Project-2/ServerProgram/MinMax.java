...
public class MinMax {
	...
	public String bestMove() {
		int eval = root.children.elementAt(0).evaluation;
		String moveOrder = root.children.elementAt(0).moveString;
		for(int i=1; i<root.numChildren; i++) {
			if(root.children.elementAt(i).evaluation > eval) {
				eval = root.children.elementAt(i).evaluation;
				moveOrder = root.children.elementAt(i).moveString;
			}
		}
		return moveOrder;
	}
	public static void main(String[] args) {
		...
		*/
		...
		System.out.print(gameTree.bestMove());
		System.out.print("\nEvaluation: ");
		System.out.print(gameTree.root.evaluation);
		System.out.println();
	}
}
